 ...
 * for the magneto community edition
 *
 * PHP Version 5.2.13
 *
 * @category Magento
...
/**
 * Encryption class for magento community edition
 *
 * @category Magento
 * @package  Ikonoshirt_Pbkdf2
 * @author   Fabian Blechschmidt <fabian.blechschmidt@ikonoshirt.de>
 ...
 * @link     https://github.com/ikonoshirt/pbkdf2
 */
class Ikonoshirt_Pbkdf2_Model_Stub_CE extends Mage_Core_Model_Encryption
    implements Ikonoshirt_Pbkdf2_Model_Stub_Interface
{
    ...
    {
        $this->_realHashModel =
            Mage::getModel('ikonoshirt_pbkdf2/encryption', array($this));
    }
